...
impl DaService for BitcoinService {
    ...
    ) -> Vec<<Self::Spec as crate::da::DaSpec>::BlobTransaction> {
        let mut txs = Vec::new();
    ...
    async fn get_extraction_proof(
        &self,
        block: &Self::FilteredBlock,
        _blobs: &[<Self::Spec as crate::da::DaSpec>::BlobTransaction],
    ) -> (
        <Self::Spec as crate::da::DaSpec>::InclusionMultiProof,
        <Self::Spec as crate::da::DaSpec>::CompletenessProof,
    ) {
        info!(
...
mod tests {
    ...
    use crate::da::DaVerifier;
    use crate::da::{DaService, SlotData};
